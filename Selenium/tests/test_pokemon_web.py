...
def test_positive_login():
    ...
    email.click()
    email.send_keys('swert-sultanov@yandex.ru') 
    ...
    password.click()
    password.send_keys('vHC-UQS-jjF-9Y5') # введи тут пароль своего тестового аккаунта на stage окружении
